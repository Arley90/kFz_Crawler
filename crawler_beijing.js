/*本项目抓取入库 孔夫子二手书网站 北京地区所有书店（店名、链接、入驻日期）信息*/
...
var insertData = function(db, info, callback) {
    ...
    //保存至表beijing
    var collection = db.collection('beijing'); 
...
// 调用爬虫
for (var page = 0; page < 35; page++) {
    c.queue(['http://shop.kongfz.com/shop_list_4_' + page + '_1000000000_0.html']);
}
